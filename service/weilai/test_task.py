...
authorization_list = [
    # 格式：手机号:token:支付密码
    "13225269130:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMzM3NTQ2MTczMTIyNjgyODgwIiwiZXhwIjoxNzUxMjYyMTE2fQ.wkBAcMHQsMVz21eCl51n8aLH0qawuFw9yDQGkPvDuvM:123123",
    # 可添加多个用户
]
